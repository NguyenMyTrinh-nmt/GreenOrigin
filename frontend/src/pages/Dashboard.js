      ...
      <div className="dashboard-container">
        <aside className="sidebar">
          <nav className="nav-menu">
            ...
            <button className="nav-item" onClick={handleProductList}>
              <span className="icon">🌾</span>
              <span>Sản phẩm</span>
            </button>
            ...
            <div className="action-buttons">
              <button className="action-button add-product-button" onClick={handleAddProduct}>
                ...
                <span className="add-text">
                  <span className="add-title">Thêm sản phẩm mới</span>
                  <span className="add-sub">Tạo lô, cấp mã truy vết</span>
                </span>
                <span className="add-pill">Mới</span>
              </button>
